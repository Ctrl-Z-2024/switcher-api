...
def test_add_movement_mov01_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_01",
        }
...
def test_add_movement_mov02_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_02",
        }
...
def test_add_movement_mov03_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_03",
        }
...
def test_add_movement_mov04_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_04",
        }
...
def test_add_movement_mov05_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_05",
        }
...
def test_add_movement_mov06_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_06",
        }
...
def test_add_movement_mov07_fail():
    with patch("app.endpoints.game_endpoints.game_connection_managers") as mock_manager:
        ...
        expected_response = {
            "detail": "Movimiento inválido para la carta MovementType.MOV_07",
        }
